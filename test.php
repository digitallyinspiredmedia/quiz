...
<input type="radio" checked="checked" name="fid" id="fid" value="<?php echo $_SESSION['FBID'];  ?>" />
<label for="fid"><?php echo  $_SESSION['FBID']; ?></label>
<input type="radio" checked="checked" name="email" id="email" value="<?php echo $_SESSION['EMAIL'];  ?>" />
<label for="email"><?php echo  $_SESSION['EMAIL']; ?></label>
<input type="radio" checked="checked" name="name" id="name" value="<?php echo  $_SESSION['FULLNAME']; ?>" />
